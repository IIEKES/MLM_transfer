...
class CorpusReader:
    ...
    def __init__(self, dataset_file=None, stopwords_file=None,
        ...
        if not is_BEG_available and '<BEG>' in self.special_flag:
        ...
        word2index_items = sorted(self.word2index.items(), key=lambda x: x[1])
    ...
    def get_model_input(self, scope, x, y):
        """
        :return transformed x, transformed y, frequency_ratio x, frequency_ratio y
        """
        pass
