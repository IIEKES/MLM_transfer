...
from test_tools.li_test_tool.classify_Bilstm.deep.dataloader.corpus_reader import CorpusReader 
...
class CorpusReaderDialogTopic(CorpusReader):
    ...
    def __init__(self, dataset_file=None, min_dialog_sentence_num=2, \
        ...
        #measure_base_dir='E:\\new_proj\\test_tools.li_test_tool.classify_Bilstm.deepEmbedding-master\\test_tools.li_test_tool.classify_Bilstm.deepEmbedding\\measure'
