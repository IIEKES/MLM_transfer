...
"screenlog_fine_tune_cbert_w_cls_pg_amazon.log",
"screenlog_fine_tune_cbert_w_cls_pg_amazon_modified.log",
#"screenlog_fine_tune_cbert_w_cls_pg_yelp.log",
#"screenlog_fine_tune_cbert_w_cls_pg_yelp_modified.log",
"screenlog_fine_tune_cbert_w_cls_yelp.log",
"screenlog_fine_tune_cbert_w_cls_yelp_modified.log"
]
titles = [
    "Dataset:sub-Amazon",
    "Dataset:Amazon",
